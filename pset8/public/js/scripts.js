...
$(function() {
    ...
    var options = {
        ...
        zoom: 13,
        zoomControl: true,
        // personal touch. change map view
        mapTypeControl: true,
...
{
    // marker's position on map from input argument
    var myLatlng = new google.maps.LatLng(place["latitude"], place["longitude"]);
    
    // define image for marker
    ...
    var marker = new google.maps.Marker({
        ...
        // place marker om map
        map: map,
        // use not standart icon
        icon: image,
        // show title when mouse on marker
    ...
    // configure link for JSON query
    var parameter = "geo="+ place["postal_code"];

    // show info window on click
    marker.addListener('click', function() {
        
        // show window with load gif
        showInfo(marker);
